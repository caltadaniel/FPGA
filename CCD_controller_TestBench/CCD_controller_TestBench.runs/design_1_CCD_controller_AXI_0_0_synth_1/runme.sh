...
HD_PWD='C:/Users/calta/Dropbox/Progetti_fpga/CCD_controller_TestBench/CCD_controller_TestBench.runs/design_1_CCD_controller_AXI_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_CCD_controller_AXI_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_CCD_controller_AXI_0_0.tcl
