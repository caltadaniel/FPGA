...
HD_PWD='C:/SVN/FPGA/ADC_Stream_TB/ADC_Stream_TB.runs/design_1_ADC_AXI_INTERFACE_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ADC_AXI_INTERFACE_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ADC_AXI_INTERFACE_0_0.tcl
